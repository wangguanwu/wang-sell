        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="home">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/sell"><span class="glyphicon glyphicon-home"></span> Home</a></li>
                    <li><a href="/sell/cart/cartDetail"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a></li>
